...
(function($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        destroy: function() {
            ...
            if (select2 !== undefined) {
                ...
                select2.opts.element.removeData("select2")
                    .unbind(".select2")
                    .show();
            }
        },
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function() {
            ...
            }).html(["    <a href='#' class='select2-choice'>", "   <span></span><abbr class='select2-search-choice-close' style='display:none;'></abbr>", "   <div><b></b></div>", "</a>", "    <div class='select2-drop select2-offscreen'>", "   <div class='select2-search'>", "       <input type='text' autocomplete='off' class='select2-input'/>", "   </div>", "   <ul class='select2-results'>", "   </ul>", "</div>"].join(""));
            return container;
        },
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        addSelectedChoice: function(data) {
            var choice = $("<li class='select2-search-choice'>" + "    <div></div>" + "    <a href='#' class='select2-search-choice-close' tabindex='-1'></a>" + "</li>"),
                id = this.id(data),
                val = this.getVal(),
                formatted;
